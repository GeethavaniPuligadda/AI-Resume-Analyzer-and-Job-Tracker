...
import { UserPlus, ScanLine, CheckCircle2, XCircle } from "lucide-react";
...
function Register() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        setStatus({ type: "success", text: "Account created. Taking you to login..." });
        ...
        setStatus({ type: "error", text: data.detail || "Registration failed." });
      }
    } catch (error) {
      console.error(error);
